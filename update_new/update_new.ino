// tone preview ,alarm from the clck ,menu proper cursor //tone prev cursor  //welcome am/pm 
...
alarmSet a = {0, 0, {1000,2000,5000,7000},0, 5,false}; ///alarm en alarmSet a = {0,0,{1000,2000,5000,7000},0,5,5,false,false};
...
void welcome_updatepage() {
  ...
  //  strftime(timeStr, sizeof(timeStr), "%I:%M:%S %s", &get_time,cmp;//12
    strftime(timeStr, sizeof(timeStr), "%I:%M %p", &get_time);
...
if (buttonPressed(SW2)) {   //++
  ...
  int selectedIndex = (menu.topIndex + menu.menuIndex) % menu.menuSize;
